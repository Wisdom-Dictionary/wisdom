...
ThesaurusTableModel thesaurusTableModelFromJson(String str) => ThesaurusTableModel.fromJson(json.decode(str));
...
class ThesaurusTableModel extends BaseTableModel{
  ...
  int? _wordId;
  String? _body;
ThesaurusTableModel copyWith({  int? id,
  int? wordId,
  String? body,
}) => ThesaurusTableModel(  id: id ?? _id,
